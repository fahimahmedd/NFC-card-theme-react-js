...
function getValidReactChildren(children) {
  return A.toArray(children).filter((child) => fn(child));
}
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = F(void 0);
  ...
  function CssVarsProvider({
    ...
    const element = u(g, {
      children: [shouldGenerateStyleSheet && u(g, {
...
function createGrid(options = {}) {
  ...
  const OverflowContext = F(void 0);
  ...
  const Grid2 = N(function Grid3(inProps, ref) {
    ...
    let result = u(GridRoot, _extends({
      ...
      children: A.map(children, (child) => {
        if (fn(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = u(OverflowContext.Provider, {
...
function joinChildren(children, separator) {
  const childrenArray = A.toArray(children).filter(Boolean);
...
var import_prop_types19, _excluded16, useUtilityClasses2, SvgIconRoot, SvgIcon, SvgIcon_default;
var init_SvgIcon = __esm({
  "node_modules/@mui/material/SvgIcon/SvgIcon.js"() {
    ...
    SvgIcon = N(function SvgIcon2(inProps, ref) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GLXGQRKC.js.map
